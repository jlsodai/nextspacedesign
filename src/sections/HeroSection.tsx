      ...
      <section className="bgover min-h-screen flex flex-col" id="home">
        ...
        <div className="flex flex-1 items-center bg-cover bg-[url('https://res.cloudinary.com/dmaestro/image/upload/v1703185993/kitchen_sttepa.jpg')]">
          <div className="flex flex-1 py-12 text-gray-800 container items-center">
            <div className="bg-white/80 p-16 space-y-4 h-full">
              <h2 className="font-bold text-7xl">Elevate Spaces,</h2>
              <h3 className="text-5xl">Craft Dreams</h3>
              <div className="bg-gray-800 w-[120px] h-[10px]">&nbsp;</div>
            </div>
          </div>
        </div>

        <div className="py-10 herohalf container flex items-center">
          <h1 className="flex-1">
            <a
              href="#"
